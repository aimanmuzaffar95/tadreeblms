    ...
    <div class="my-5">
        ...
        <form class="p-5 w-50 m-auto bg-primary" method="POST" action="{{route('online_assessment.store_user_details')}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="first_name" name="first_name" required placeholder="{{ __('assignment_pages.user_details.first_name_placeholder') }}">
            </div>
            <div class="form-group">
                <label for="last_name">{{ __('assignment_pages.user_details.last_name') }}</label>
                <input type="text" class="form-control" id="last_name" name="last_name" required placeholder="{{ __('assignment_pages.user_details.last_name_placeholder') }}">
            </div>
            <div class="form-group">
                <label for="email">{{ __('assignment_pages.user_details.email') }}</label>
                <input type="email" class="form-control" id="email" name="email" required placeholder="{{ __('assignment_pages.user_details.email_placeholder') }}">
            </div>
            <div class="form-group">
                <label for="phone">{{ __('assignment_pages.user_details.phone') }}</label>
                <input type="text" class="form-control" id="phone" maxlength="15" name="phone" required placeholder="{{ __('assignment_pages.user_details.phone_placeholder') }}">
            </div>
            <div class="form-group">
